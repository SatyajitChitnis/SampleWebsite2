...
class ThinkContactForm{
    ...
    return $wpsf_settings;
		...
		echo '<div style="border:1px solid black;width:50%;margin:auto;">';
		echo '<form id="cf-email" action="'. plugin_dir_url(__FILE__).'emailSubmit.php" method="post" style="margin: 35px;"><br />';
